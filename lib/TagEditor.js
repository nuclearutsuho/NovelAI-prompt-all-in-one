        ...
        if (isDynHeader) {
            toolbarHtml += `
                <div class="dyn-config-control">
                    <input type="text" class="dyn-config-input dyn-min" title="${minConfigTitle}" placeholder="${minPlaceholder}">
                    <span>-</span>
                    <input type="text" class="dyn-config-input dyn-max" title="${maxConfigTitle}" placeholder="${maxPlaceholder}">
                    <input type="text" class="dyn-config-input dyn-sep sep" title="${sepConfigTitle}" placeholder="">
                </div>`;
        } else if (isNewline) {
            toolbarHtml += `
                <input type="text" class="divider-name-input" value="${common.escapeHtml(tag.dividerName || '')}" placeholder="${dividerPlaceholder}" title="${dividerTitle}">
