export default class Autocomplete {
    ...
    initResizer() {
        ...
        const onMouseUp = () => {
            ...
            chrome.storage.local.set({ autocompleteHeight: this.listEl.style.maxHeight });
        };
    ...
    renderDropdown(matches) {
        ...
        if (this.activeInput) {
            ...
            const dropdownHeight = this.dropdown.offsetHeight || Math.min(300, matches.length * 28 + 14); // estimation
